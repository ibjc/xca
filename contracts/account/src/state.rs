...
impl XRequest{
  pub fn deserialize(data: &Vec<u8>) -> StdResult<Self>{
    ...
    let sender_chain_id = data.get_u64(9);
    //let sender_address = data.get_const_bytes::<32>(49);
    let emitter_chain_id = data.get_u64(17);
    //let emitter_address = data.get_const_bytes::<32>(89);
    let destination_chain = data.get_u64(25);
    //let destination_address = data.get_const_bytes::<32>(129);
    let is_response_expected = data.get_u8(33);
    let is_executable = data.get_u8(34);
    let execution_dependency_chain_id = data.get_u64(35);
    let execution_dependency_sequence = data.get_u64(43);
   // let caller = data.get_const_bytes::<32>(179);
    let response_of_chain_id = data.get_u64(51);
    let response_of_sequence = data.get_u64(59);
    let request_status = data.get_u8(67);
    let response_chain_id = data.get_u64(68);
    let response_sequence = data.get_u64(76);
    let nonce = data.get_u32(84);
    */
